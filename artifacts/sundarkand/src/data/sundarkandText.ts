जानउँ मैं तुम्हारि प्रभुता।सुनु सठ अस मम बचन सुता।
कह सुक नाथ कृपाँ तव तारा।उबरे सुनि रघुबीर दुलारा॥
॥ चौपाई ॥
सुनहु नाथ सागर सन जाई।करहु बिनय थोरी सहसाई॥
गए पवनसुत समुझाए।रघुपति कर बधि बचन सुनाए॥
तासु बचन मन अनुरागे।नाथ बड़ो तुम्हार उर भावा॥
सुनि कपि बचन बिहसि बिहरावा।समुझहु सुक अस मन निरधारी॥
नाथ विरोध न उबरे कोई।कह रघुबीर अभय सब होई॥
॥ दोहा 54 ॥
...
export type VerseType = "shlok" | "chaupai" | "doha" | "chhand" | "header" | "section-header";
...
function parseText(): { preamble: Verse[]; sections: Section[] } {
  const lines = SUNDARKAND_RAW.split("\n").map(l => l.trim()).filter(l => l.length > 0);

  const preamble: Verse[] = [];
  const sections: Section[] = [];

  let currentSection: Section | null = null;
  let currentVerseType: VerseType = "header";
  let currentVerseLines: string[] = [];
  let currentVerseNumber: number | undefined;
  let inPreamble = true;

  function flushVerse() {
    if (currentVerseLines.length === 0) return;
    const verse: Verse = {
      type: currentVerseType,
      lines: [...currentVerseLines],
  ...
  for (const line of lines) {
    // Section header like "श्री राम चरित मानस-सुन्दरकाण्ड (दोहा 1 - दोहा 6)"
    const sectionMatch = line.match(/श्री राम चरित मानस-सुन्दरकाण्ड \(दोहा (\d+) - दोहा (\d+)\)/);
    if (sectionMatch) {
      flushVerse();
      inPreamble = false;
      const startDoha = parseInt(sectionMatch[1]);
      const endDoha = parseInt(sectionMatch[2]);
      currentSection = {
        title: line,
        startDoha,
        endDoha,
    ...
    // Main title
    if (line === "श्री राम चरित मानस-पञ्चम सोपान सुन्दरकाण्ड") {
      flushVerse();
      currentVerseType = "header";
      currentVerseLines = [line];
      flushVerse();
      continue;
    }
    ...
    if (line === "॥ श्लोक ॥") {
      flushVerse();
      currentVerseType = "shlok";
      continue;
    }
    if (line === "॥ चौपाई ॥") {
      flushVerse();
      currentVerseType = "chaupai";
      continue;
    }
    if (line === "॥ छन्द ॥") {
      flushVerse();
      currentVerseType = "chhand";
      continue;
    }

    // Doha marker
    const dohaMatch = line.match(/^॥ दोहा (\d+) ॥$/);
    if (dohaMatch) {
      flushVerse();
      currentVerseType = "doha";
      currentVerseNumber = parseInt(dohaMatch[1]);
      continue;
    }

    // Content line - add to current verse
...
export const { preamble: PREAMBLE_VERSES, sections: SECTIONS } = parseText();
